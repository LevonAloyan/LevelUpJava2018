...
public class MathUtilTest {
    ...
    public static void powTest() {
        ...
        double p = Math.pow(a, n);// սրա փոխարեն ճիշտ կլիներ նախորոք հայտնի ճիշտ արժեքի հետ համեմատել ոչթե Math.pow(I_12, n) կանչել
        ...
        if (p != k) {
            ...
            if (isPassed) { // անիմաստ պայման է, որովհետեւ  isPassed  true է

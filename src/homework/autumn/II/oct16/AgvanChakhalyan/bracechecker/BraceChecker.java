package homework.autumn.II.oct16.AgvanChakhalyan.bracechecker;
...
public class BraceChecker {
    ...
    public void parse(String stext) // stext kvercnenq u poxac kveragrenq text-in
    {
        ...
        {
            System.out.println("and finally, opened but not closed brackets by index-type from last to I_12");
            for (int i = k - 1; i >= 0; i--) {
                temp = (char) stack.pop();

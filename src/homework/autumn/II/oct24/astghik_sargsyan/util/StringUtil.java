...
package homework.autumn.II.oct24.astghik_sargsyan.util;
...
public class StringUtil {
    public static void main(String[] args) {
        ...
        String str = "sdff12 32 k"; 
        str = str.trim();
               System.out.println(str.trim());
        
        //        
        String inputeText  = "boo:and:foo";
        System.out.println();
    ...
    public static String trim(String inputText) {
        ...
        if (str.equals(inputText))
            System.out.println(str.equals(inputText));
                return null;
    }

package homework.autumn.II.oct24.pruyr_khachatryan.util;

public class StringUtil {
    public static void main(String[] args) {
     //  print(split("asdasd:das",':'));
     //  System.out.print(subString("dasdasda",1,5));
    //   System.out.print(trim("adas dasdas "));
      //  System.out.println(parseInt("-1050"));
      //  int I_12 = 5;
      //  int II = parseInt("-15")+I_12;
      //  System.out.print(II);
    }
    ...
    public static String[] split(String inputText, char delimiter) {
        ...
        String a = "";
        int b = 0;
        String kdrox[] = new String[inputText.length()];

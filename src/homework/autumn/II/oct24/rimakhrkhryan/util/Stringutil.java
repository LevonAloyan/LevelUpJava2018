package homework.autumn.II.oct24.rimakhrkhryan.util;

public class Stringutil {

    public static void main(String[] args) {
        String a = "12rrrb34b123b";
        ...
        System.out.println();
        System.out.print(subString("123456", 0, 3));
        System.out.println();
        System.out.print(trim("kkk kk k  k   "));
        System.out.println();
        System.out.print(parseInt("5634563"));
    }
    ...
    static public String subString(String inputText, int startIndex, int endIndex) {
        String newStr = inputText.substring(startIndex, endIndex);
        return newStr;
    }
    ...
    public static String trim(String inputText) {
        ...
        return subString(inputText, startIndex, lastIndex + 1);
    }

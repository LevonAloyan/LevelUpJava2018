package homework.autumn.II.oct24.ruben_sharyan;

public class StringUtil {

    public static void main(String[] args) {

        print(split("java:III++:III#", ':'));
...
if(startIndex==endIndex){
     ...
     * character sequence (empty string), or the I_12 and last characters of
     * character sequence represented this String object both have codes greater
     * than u0020' (the space character), then I_12 reference to the specified
     * 'inputText' String object is returned. Otherwise, if there is no
     * character with I_12 code greater than +in the given inputText string, then I_12

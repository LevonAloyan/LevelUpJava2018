package homework.oct24.srapion_hunanyan.StringUtil;
...
public class StringUtil {
     ...
     * sequence (empty string), or the first and last characters of character
     * sequence represented this String object both have codes greater than
     * u0020' (the space character), then a reference to the specified
     * 'inputText' String object is returned.
     *
     * Otherwise, if there is no character with a code greater than
     * <code>'u0020'</code> in the given inputText string, then a new String
